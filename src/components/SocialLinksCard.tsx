...
export const SocialLinksCard = () => {
  ...
  return <BentoCard className="mx-[2px]">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        return <a key={link.name} href={link.url} target="_blank" rel="noopener noreferrer" className="aspect-square bg-white/5 rounded-xl flex items-center justify-center hover:bg-white/10 transition-all group border border-white/20">
