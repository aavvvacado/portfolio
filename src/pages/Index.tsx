    ...
    <div className="min-h-screen bg-background p-4 md:p-6 lg:p-8 animate-fade-in">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-auto">
          ...
          {/* Row 2 */}
          <div className="animate-fade-in row-span-2" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            <DailyStackCard />
          </div>
          ...
          <div className="animate-fade-in row-span-2" style={{ animationDelay: '0.7s', animationFillMode: 'both' }}>
            <ProjectsCard />
          </div>
          
          {/* Row 3 */}
          <div className="animate-fade-in row-span-2" style={{ animationDelay: '0.8s', animationFillMode: 'both' }}>
            <StoryCard />
          </div>
          <div className="animate-fade-in row-span-2" style={{ animationDelay: '0.9s', animationFillMode: 'both' }}>
            <TestimonialsCard />
          </div>
        </div>
      </div>
